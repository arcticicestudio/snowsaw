# Contributing to snowsaw

Thanks for contributing to snowsaw!

This is a set of guidelines for contributing to snowsaw. Please take a moment to review this document in order to make the contribution process easy and effective for everyone involved.

Following these guidelines helps to communicate that you respect the time of the developers managing and developing this open source project. In return, they should reciprocate that respect in addressing your issue, assessing changes, and helping you finalize your pull requests.

As for everything else in the project, the contributions to snowsaw are governed by our [Code of Conduct][gh-coc]. By participating, you are expected to uphold this code. Please report unacceptable behavior at support@arcticicestudio.com or directly to one of the core team members via [email][gh-mailmap].
...
A bug is a _demonstrable problem_ that is caused by the code in the repository. This section guides you through submitting a bug report for snowsaw. Following these guidelines helps maintainers and the community understand your report, reproduce the behavior and find related reports.
...
- **Optionally include screenshots and animated GIFs** if appropriate which show you following the described steps and clearly demonstrate the problem.
- **Provide specific examples to demonstrate the steps**. Include links to files or GitHub projects, or copy/paste snippets. If you are providing snippets in the issue, use [Markdown code blocks][gh-help-markdown-code-blocks] or [attach files to the issue][gh-help-attach-file].

If possible please provide more context by answering these questions:

- **Did the problem start happening recently** e.g. after updating to a new version of snowsaw or was this always a problem?
  - If the problem started happening recently, **can you reproduce the problem in an older version of snowsaw?**
...
- **Provide examples to demonstrate the need of an enhancement**. Include copy/paste snippets which you use in those examples, use [Markdown code blocks][gh-help-markdown-code-blocks] or [attach files to the issue][gh-help-attach-file].
- **Describe the current behavior** and **explain which behavior you expected to see instead** and why.
- **Explain why this enhancement would be useful** to most snowsaw users.
...
- **Optionally include screenshots and animated GIFs** if appropriate which show you following the described steps and clearly demonstrate the change.
- **Make sure to follow the [Markdown](#markdown-style-guide) and [Git](#git-style-guide) style guides**.
...
snowsaw's documentation consists of guides, which helps users to learn about the project.

You can help improve the documentations and guides by making them more coherent, consistent or readable, adding missing information, correcting factual errors, fixing typos, bringing them up to date when there are differences to the latest version. This can be done by submitting a [enhancement suggestion](#enhancement-suggestions) and then opening a [pull request](#pull-requests) for it.

## Branch Organization

snowsaw uses the [gitflow][] branching model. The repository consists of two core branches with an infinite development lifecycle:
...
We're always looking for more opinions on discussions in issues and pull request reviews which is a good opportunity to influence the future direction of snowsaw.
...
snowsaw adheres to the [Arctic Ice Studio Markdown Style Guide][gh-styleguide-markdown].
...
snowsaw adheres to the [Arctic Ice Studio Git Style Guide][gh-styleguide-git].
...
The recommended way for GitHub based projects is to create it as [Gist][gh-gist] or new repository, but of course you can [attach it to issues and pull requests as files][gh-help-attach-file], use any free code paste- or file hosting service or paste the code in [Markdown code blocks][gh-help-markdown-code-blocks] into the issue.
...
[gh-branch-develop]: https://github.com/arcticicestudio/snowsaw/tree/develop
[gh-changelog]: https://github.com/arcticicestudio/snowsaw/blob/develop/CHANGELOG.md
[gh-coc]: https://github.com/arcticicestudio/snowsaw/blob/develop/CODE_OF_CONDUCT.md
[gh-gist]: https://gist.github.com
[gh-help-attach-file]: https://help.github.com/articles/file-attachments-on-issues-and-pull-requests
...
[gh-issues-label-question]: https://github.com/arcticicestudio/snowsaw/labels/type-question
[gh-issues-template-bug]: https://github.com/arcticicestudio/snowsaw/blob/develop/.github/ISSUE_TEMPLATE/bugs.md
[gh-issues-template-enhancement]: https://github.com/arcticicestudio/snowsaw/blob/develop/.github/ISSUE_TEMPLATE/enhancement.md
[gh-issues-template-pr]: https://github.com/arcticicestudio/snowsaw/blob/develop/.github/PULL_REQUEST_TEMPLATE.md
[gh-issues-templates]: https://github.com/arcticicestudio/snowsaw/issues/new/choose
[gh-issues]: https://github.com/arcticicestudio/snowsaw/issues
[gh-mailmap]: https://github.com/arcticicestudio/snowsaw/blob/develop/.mailmap
[gh-pr]: https://github.com/arcticicestudio/snowsaw/pulls
[gh-releases-latest]: https://github.com/arcticicestudio/snowsaw/releases/latest
